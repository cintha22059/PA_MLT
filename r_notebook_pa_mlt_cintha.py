# -*- coding: utf-8 -*-
"""R_notebook_PA_MLT_Cintha.ipynb
...
for k in K:
    ...
    ch_scores.append(calinski_harabasz_score(data_selected_features, kmeans.labels_))
...
"""Dengan fitur yang ada ternyata nilai silhoutte score masih rendah."""
...
for k in K:
    ...
    ch_scores.append(calinski_harabasz_score(data_update_features, kmeans.labels_))
...
print(f"data_update_features: {silhouette_data_update_features}")
print(f"data_selected_features: {silhouette_data_selected_features}")
print(f"data_selected_features_dbscan: {silhouette_data_selected_features_dbscan}")

# memutuskan skema terbaik
silhouette_scores = {
    "data_selected_features (KMeans model 1)": silhouette_data_selected_features,
    "data_update_features (KMeans model 2)": silhouette_data_update_features,
    "data_selected_features (DBSCAN)": silhouette_data_selected_features_dbscan
}
